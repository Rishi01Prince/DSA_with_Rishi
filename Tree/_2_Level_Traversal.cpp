...
public:
    ...
    void Level_Traversal_W1(Node *curr)
    {
        queue<Node *> q;
        if (curr == NULL)
        {
    ...
    void Level_Traversal_W2(Node *curr)
    {
        queue<Node *> q;
        if (curr == NULL)
        {
...
int main()
{
    ...
    while (q)
    {
        ...
        else if (v == 1)
        {
            ...
            cout << "Tree Breadth Wise Traversal  way1  :- "<<endl;
            t.Level_Traversal_W1(t.root);
            cout << endl;
        }
        else if (v == 2)
        {
            cout << "Tree Breadth Wise Traversal  way2  :- "<<endl;
            t.Level_Traversal_W2(t.root);
            cout << endl;
        }
        else if (v == 3)
        {
