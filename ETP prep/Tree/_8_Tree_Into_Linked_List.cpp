...
public:
    ...
    Node* Tree_to_Linked_List(Node *curr){
        if (curr == NULL)
        {
            return curr;
        }

        Node* head = Tree_to_Linked_List(curr->left);
        ...
        prev = curr;
        Tree_to_Linked_List(curr->right);
        return head;
...
int main()
{
    ...
    while (q)
    {
        ...
        if (v == 0)
        {
            ...
            cout << "3--> Inoreder Traversal  " << endl;
            cout << "4--> Size  " << endl;
            cout << "5--> Tree Height  " << endl;
            cout << "6--> Linked List Form " << endl;
            cout << "7-->Lined List Traversal" << endl;
